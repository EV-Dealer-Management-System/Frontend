...
const UpdateAppointmentSettingForm = ({
  appointmentId,
  initialValues,
  onSuccess,
  onCancel,
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await UpdateAppointmentSetting.updateAppointmentSetting(
        appointmentId,
        values.allowOverlappingAppointments,
      ...
      if (response.isSuccess) {
        ...
        message.error(
          response.message || "Cập nhật appointment setting thất bại"
        );
      }
    } catch (error) {
